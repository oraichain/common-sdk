...
import {InstantiateMsg, ExecuteMsg, QueryMsg, Call, CallOptional, MigrateMsg, AggregateResult, CallResult, BlockAggregateResult, ContractVersion} from "./Multicall.types";
