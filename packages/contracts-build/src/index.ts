...
export type ContractName = 'multicall' | 'cw-ics20-latest' | 'cw-ics721-bridge' | 'cw1-subkeys' | 'cw1-whitelist' | 'cw20-base' | 'cw721-base' | 'cw20-ics20' | 'cw3-fixed-multisig' | 'cw3-flex-multisig' | 'cw4-group' | 'cw4-stake';
